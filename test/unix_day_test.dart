import 'package:d4_time/src/day.dart';
...
void main() {
  ...
  test("timeDay.every(step) returns every stepth day", () {
    expect(
        timeDay
            .every(3)!
    ...
    expect(
        timeDay
            .every(5)!
            .range(utc(2008, 11, 30, 0, 12), utc(2009, 0, 6, 23, 48)),
        [utc(2009, 0, 1), utc(2009, 0, 6)]);
    expect(
        timeDay
            .every(7)!
            .range(utc(2008, 11, 30, 0, 12), utc(2009, 0, 8, 23, 48)),
        [utc(2009, 0, 1), utc(2009, 0, 8)]);
  });
}
